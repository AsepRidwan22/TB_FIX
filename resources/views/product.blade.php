...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('print.product') }}" target="_blank" class="btn btn-secondary"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($product->photo !== null)
                                                <img src="{{ asset('storage/app/public/photo_product/' . $product->photo) }}"
                                                    width="100px">
                                            @else
    ...
    {{-- Tambah Data --}}
    <div class="modal fade" id="tambahProductModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
